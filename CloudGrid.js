...
(function($, _) {
	...
	var CloudGrid = function(data, options) {
		...
		this.attachEvents = function() {
			...
			for (var event in events) {
				...
				$(this.gridSelector).on('cg_selected', function(){
					console.log('WORKKK');
				});
	...
	$.extend(CloudGrid.prototype, {
		render: function(){
			...
			$(this.gridSelector).on('click', 'tr', this.onRowClick);
			$(this.gridSelector).on('hover', 'tr', this.onRowHover);
			$(this.gridSelector).on('dblclick', 'tr', this.onRowDblClick);
		},
		//Add row to template
		addRow: function(row) {
